...
Thus, the simplest mathematical model of a neuron contains several inputs $X_1$, $X_2$, ..., $X_N$ and an output Y, and a series of weights $W_1$, ..., $W_N$. An output is calculated as:
